...
#   'Dodge Ram': ('white', 2017, 2.4, 'pickup', 40000),
#   'Ford F-Series': ('gray', 2021, 3.5, 'pickup', 50000),
#   'Nissan Titan': ('silver', 2018, 5.6, 'pickup', 35000)
# }
# search_criteria = (2017, 2.4, 40000)
#
# list_res: list = []
...
#
# list_res: list = [{car: data} for car, data in car_data.items() if data[1] == search_criteria[0] and data[2] == search_criteria[1] and data[4] == search_criteria[2]]
#
# sorted_list = sorted(list_res, key=lambda x: list(x.values())[-1])
# print(list_res)
# # print(sorted_list)